...
\begin{center}
\includegraphics{capacitors/delay.eps}
\end{center}
...
\begin{center}
\includegraphics{capacitors/comparator_square_generator.eps}
\end{center}
...
\item A 200~nF capacitor charges through a 2~k$\Omega$ resistor, starting at zero volts.  Graph both the current through the capacitor and voltage across the capacitor as a function of time.  At what time is the capacitor voltage reach 90\% of the supply voltage?  
