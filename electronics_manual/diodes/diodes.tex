...
\item The circuit diagram below  shows two resistors connected in series to a transformer.  Although the diagram shows the same transformer you used in Lab 10, you should instead use the 12.6~VAC transformer on your PB-505.  The diagram also shows your oscilloscope measuring the voltages across both of the resistors, but instead of graphing them both vs. time, here you will graph the voltage across one resistor vs. the voltage across the other.  To do this, under the ``aquire'' menu of your scope, select ``XY format ON.''   Also, under the channel 2 menu, select ``invert on.''  Since the two resistors in your circuit are identical, the display here should show a 45 degree diagonal line, the graph of $y = x$.  What does your display show if you disconnect either the channel 1 or channel 2 probe?
\vspace{-0.1in}
\begin{center}
...
\item On your scope, turn XY formate mode OFF, and also \textit{do not forget to turn the Ch2 invert OFF}.  Build the ``series clipper'' circuit%
