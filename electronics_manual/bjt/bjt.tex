...
\begin{center}
\includegraphics{bjt/buffer_one_led.pdf}
\end{center}
...
\begin{center}
\includegraphics{bjt/buffer_four_leds.pdf}
\end{center}
...
\item Set your signal generator to output a 1~kHz sine wave with a 4~V peak voltage with no load.  Now hook it up to a load resistance of 1~k$\Omega$ and record the actual peak voltage across the load resistor.  Is this consistent with the internal resistance of the signal generator?  (See Lab~\ref{lab_input_output_impedance}.)
 \begin{center}
\includegraphics{bjt/unamplified_ac.pdf}
\end{center}
...
\begin{center}
\vspace{-0.08in}
\includegraphics{bjt/ac_with_emit_follower.pdf}
\vspace{-0.08in}
\end{center}
...
\begin{center}
\vspace{-0.08in}
\includegraphics{bjt/emit_follower_biased_input.pdf}
\vspace{-0.08in}
\end{center}
...
\begin{center}
\vspace{-0.08in}
\includegraphics{bjt/biased_output_and_input_incorrect.pdf}
\vspace{-0.08in}
\end{center}
...
\begin{center}
\includegraphics{bjt/biased_output_and_input_correct.pdf}
\end{center}
