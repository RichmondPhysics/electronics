...
\end{equation*}
Use a differential amplifier like the one pictured below to create a triangle wave that sweeps between $-8$ and 0 volts.  You can use the output of your function generator (set to whatever amplitude you want) and the output from your 5V DC supply, and you can change the values of the resistors $R_1$ and $R_2$ below to whatever you like.  \label{part_differential}
\begin{center}
