...
In a proportional controller, the power (or voltage) sent to a device is \textit{proportional} to the difference between the actual reading of the sensor and the ``setpoint'' value that is desired.  As one example, the cruise control in a car maintains a constant speed by depressing the accelerator pedal by an amount that is proportional to the difference between the desired speed and the car's actual speed.
...
Show your completed circuit to your instructor to demonstrate that it functions as it is supposed to.  As with all of your labwork, document your progress in your lab notebook as you go.  Be sure to include in your notebook a full circuit diagram of your final circuit, showing the values of all components and laid out reasonably neatly on the page.