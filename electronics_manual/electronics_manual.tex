...
\documentclass[english,12pt,twoside]{labmanual} %labmanual.cls is a modified version of article.cls, 
...
%\includeonly{voltage_dividers/voltage_dividers}
...
\newcommand{\supplementmark}{Lab }

\titleformat{\section}{\normalfont\Large\bfseries}{\supplementmark \thesection}{1em}{}
\fancyhead[LO,RE]{\slshape \rightmark} 
\fancyhead[LE,RO]{\slshape \MakeUppercase{\supplementmark}\leftmark} % Reversed LE, RO to  LO,RE to make headers come out correctly on even/odd 
%\usepackage{emptypa‌​ge}
...
\let\oldpart\part% See above
\renewcommand{\part}{\cleardoublepage\oldpart}% Prepend new \part with \cleardoublepage
...
\let\oldsupplementmark\supplementmark %All of this buisiness is to keep from getting ``Lab'' at the top of the toc
\renewcommand{\supplementmark}{}
\tableofcontents{}
...
%--------------------------------------------
\part{The Basics}
\renewcommand{\supplementmark}{\oldsupplementmark}
