...
\begin{center}
\raisebox{0.5in}{\includegraphics[scale=0.4]{relays/relay_picture.pdf}}
\hspace{0.3in}
...
Use your oscilloscope to monitor both the voltage across the relay coil and the voltage across both 10~k$\Omega$ resistors, producing a graph similar to that on the right.  
...
\item What does your graph from the previous part look like when you remove the 5~VDC from the coil?  Measure these delay times $\Delta t$ as well.
