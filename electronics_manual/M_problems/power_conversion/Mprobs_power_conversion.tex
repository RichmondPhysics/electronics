...
In the figure above on the right, the 12~V power supply from the previous circuit has been replaced with an 8~V power supply.  Find the voltages and currents for all resistors and for the diode.\end{Exercise}
\begin{Answer}
$V_{R1}=1.33~\text{V};
V_{R2}=2.67 ~\text{V};
V_{R3}=4.0~\text{V};
...
\vspace{-0.1in}
\begin{center}
\includegraphics[scale=0.8]{M_problems/power_conversion/led_bulb_prob1.pdf}
\end{center}
\vspace{-0.1in}
