...
%--------------------------------------------------------------------------------------------------------------
\begin{Exercise}
In Lab~\ref{lab_equipment} you found which rows and columns of your breadboard are connected to each other.  Based on those findings, calculate the resistance between the two purple wires for each of the four arrangements of resistors on breadboards below.  (The resistors' wire leads are drawn in red for clearer visibility.) Be forewarned that two of the four have apparently been ``miswired'' in that the actual resistance is  not what was likely intended.
\begin{center}
\includegraphics{M_problems/the_basics/resistors_on_breadboard.pdf}
\index{color page}
\end{center}
\end{Exercise}
\begin{Answer}
(a) $R=30\kohm$ (b) $R=30\kohm$ (c) $R= 15\kohm$ (d) $R=\infty$
\end{Answer}
...
%--------------------------------------------------------------------------------------------------------------
\begin{Exercise}
As shown in the figure to the right, two resistors in series may be thought of \hspace*{0.25\textwidth}

\vspace{-1.4ex}
\begin{minipage}[t]{0.75\textwidth}
as a \textit{voltage divider}, 
...
\end{minipage}
\begin{minipage}[t]{0.25\textwidth - 4pt}
...
\hspace{\fill}\includegraphics{M_problems/the_basics/troubleshooting_IV_series.pdf}
...
\hspace{\fill}\includegraphics[scale=0.9]{M_problems/the_basics/troubleshooting_voltage_divider_masked.pdf}
