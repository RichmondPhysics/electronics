...
\figuretoright{0.28}[scale=0.9]{M_problems/C_L_and_AC/charge_and_short_capacitor.pdf} {
\begin{itemize}[nosep]
...
\figuretoright{0.50}{M_problems/C_L_and_AC/comparator_square_generator.pdf} {
...
\figuretoright{0.38}{M_problems/C_L_and_AC/transformer_narrow.pdf} {
	\begin{enumerate}[label=(\alph*),wide]
...
\figuretoright{0.30}{M_problems/C_L_and_AC/diode_circuit1.pdf} {
...
\end{Exercise}
\begin{Answer}
(a) 2.2 V (b) 2.8 V and 2.2 V (c) 2.8 mA and 5.5 mA (d) We can't have $I_{R2}>I_{R1}$, because the only way for that to be true would be the current through the diode to be \textit{negative}, that is, flowing in the reverse direction. That would directly contradict the assumption that the diode has a forward current. (e)~open (f)~$V_{R1}=3.57$~V; $V_{R2}=1.43$~V; $I_D=0.$
\end{Answer}
...
\hfill
\includegraphics{M_problems/C_L_and_AC/diode_circuit2.pdf}
\hfill
\includegraphics{M_problems/C_L_and_AC/diode_circuit3.pdf}
\hfill\vspace*{0pt}
...
\begin{center}
\includegraphics{M_problems/C_L_and_AC/power_in_shunt_diode.pdf}
\end{center}
\end{Exercise}
\begin{Answer}
(a) 1.52 mW (b) 2.79 mW
...
\begin{center}
\includegraphics{M_problems/C_L_and_AC/led_bulb_prob1.pdf}
\end{center}
...
\begin{center}
\includegraphics{M_problems/C_L_and_AC/shunt_clipper_dc_prob.pdf}
\end{center}
\end{Exercise}
\begin{Answer}
