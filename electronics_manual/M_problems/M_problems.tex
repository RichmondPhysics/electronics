...
\input{M_problems/the_basics/Mprobs_the_basics}
\input{M_problems/opamps_digital/Mprobs_opamps_digital}
\input{M_problems/power_conversion/Mprobs_power_conversion}
\begingroup
	...
	\input{M_problems/complex_numbers/Mprobs_complex_numbers}
	\addtocounter{subsection}{-1}
\endgroup
\input{M_problems/Z_and_AC/Mprobs_Z_and_AC}
\input{M_problems/relays_transistors/Mprobs_relays_transistors}
\input{M_problems/applications/Mprobs_applications}
