...
\begin{center}
\includegraphics[scale=0.8]{appendices/pinouts/man72.pdf}
\includegraphics{counters/man72_circuit.pdf}
\end{center}
...
\includegraphics[scale=0.8]{appendices/pinouts/74LS47.pdf}
\end{minipage}
...
\begin{center}
\includegraphics[scale=0.8]{appendices/pinouts/man74.pdf}
\includegraphics{counters/man74_circuit.pdf}
\end{center}
...
\vspace{-0.2in}
\begin{center}
\includegraphics[scale=0.8]{appendices/pinouts/cd74hc390e.pdf}
\end{center}
\vspace{-0.1in}
